# Reindent from 2 to 4 spaces \(or vice versa\)
...
def main():
    import getopt
    global verbose, recurse, dryrun, makebackup, spec_newline, spaces
    try:
        opts, args = getopt.getopt(sys.argv[1:], "drnvh",
            ["dryrun", "recurse", "nobackup", "verbose", "newline=", "spaces=", "help"])
